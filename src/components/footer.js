            ...
            <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
                ...
                <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                    <div className="mx-auto max-w-sm lg:max-w-none">
                        <p className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">At FarmConnect, we are on a mission to empower farmers and revolutionize the agricultural industry. Our goal is to connect farmers with markets efficiently and sustainably, ensuring that their hard work and dedication yield the best possible results.</p>
                ...
                <div className="mt-16 border-t border-gray-100 pt-8">
                    ...
                    &copy; {new Date().getFullYear()} Farmconnect. All rights reserved.
                       ...
                       &nbsp;
                        <a href="https://cloudproductivity-solutions.com/" target="_blank" className="text-secondary dark: no-underline transition hover:text-secondary dark:/75">A product of  Cloud Productivity Solutions Company</a>
                    </p>
                </div>
            </div>
        </footer>
